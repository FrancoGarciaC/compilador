...
void* fd4___map1 (void** fd4_clo, void** fd4_g) {
  return (void *)(({
    void** fd4_x = (fd4_clo)[3];
    ({
      void** fd4_map = (fd4_clo)[2];
      ({
        void** fd4_f = (fd4_clo)[1];
        fd4_x
        ? (void *)({
            void** fd4_res = ((void* (*) (void*, void*)) (fd4_f)[0])( (void *)fd4_f
            , (void *)fd4_x );
            ({
              void** fd4_res2 = ((void* (*) (void*, void*)) (fd4_g)[0])( (void *)fd4_g
              , (void *)fd4_x );
              ({
                void** fd4___var3 = ({
                  void** fd4___var2 = ((void* (*) (void*, void*)) (fd4_map)[0])( (void *)fd4_map
                  , (void *)({
...
void* fd4___map0 (void** fd4_clo, void** fd4_f) {
  return (void *)(({
    ...
    ({
      ...
      fd4_mkclosure(fd4___map1, 3, fd4_f, fd4_map, fd4_x);
    });
  }));
}
...
void* fd4___mapP0 (void** fd4_clo, void** fd4_j) {
  return (void *)(({
    void** fd4_h = (fd4_clo)[1];
    ({
      wprintf(L"h-j:=");
      fd4_printn((uint64_t)({
        fd4_sub((uint64_t) fd4_h, (uint64_t) fd4_j);
      }));
    });
  }));
}
void* fd4_mapP (void** fd4_mapP, void** fd4_h) {
  return (void *)(fd4_mkclosure(fd4___mapP0, 1, fd4_h));
}
void* fd4_final;
uint64_t* fd4main() {
  fd4_final = (void *)(({
    void** fd4___var4 = ({
      void** fd4___var3 = ((void* (*) (void*, void*)) fd4_map)( (void *)fd4_mkclosure( fd4_map
      , 0 )
      , (void *)20 );
      ((void* (*) (void*, void*)) (fd4___var3)[0])( (void *)fd4___var3
    ...
    ((void* (*) (void*, void*)) (fd4___var4)[0])( (void *)fd4___var4
    , (void *)((void* (*) (void*, void*)) fd4_mapP)( (void *)fd4_mkclosure( fd4_mapP
    , 0 )
    , (void *)100 ) );
  }));
