...
void** fd4_prod (void**  fd4_prod, uint64_t  fd4_m) {
  return fd4_mkclosure(fd4___prod0, 2, fd4_prod, fd4_m);
}
uint64_t fd4_fact (void**  fd4_fact, uint64_t  fd4_x) {
  return fd4_x
  ? ({
