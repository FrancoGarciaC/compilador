...
uint64_t fd4___temp0 (void**  fd4_clo, uint64_t  fd4_n) {
  return ({
...
void** fd4_suma (void**  fd4_clo, uint64_t  fd4_m) {
  return fd4_mkclosure(fd4___temp0, 2, fd4_suma, fd4_m);
}
void** fd4_temp (void**  fd4_temp_clo, uint64_t  fd4_dummy) {
  return ({
    void**  fd4_suma_clo = fd4_mkclosure(fd4_suma, 1, fd4_clo);
    ({
      void**  (* fd4_suma) (void**,  uint64_t  ) = fd4_suma_clo[0];
      fd4_suma_clo;
    });
