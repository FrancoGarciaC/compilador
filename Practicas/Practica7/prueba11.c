...
void** fd4___final1 (void**  fd4_clo, uint64_t  fd4_y) {
  return ({
    uint64_t  fd4_c = fd4_clo[2];
    ({
      uint64_t  fd4_x = fd4_clo[1];
      fd4_mkclosure(fd4___final2, 3, fd4_y, fd4_x, fd4_c);
    });
  });
}
void** fd4___final0 (void**  fd4_clo, uint64_t  fd4_x) {
  return ({
    uint64_t  fd4_c = fd4_clo[1];
    fd4_mkclosure(fd4___final1, 2, fd4_x, fd4_c);
  });
}
uint64_t fd4___final5 (void**  fd4_clo, uint64_t  fd4_q) {
  return ({
    uint64_t  fd4_c = fd4_clo[5];
    ({
...
void** fd4___final3 (void**  fd4_clo, uint64_t  fd4_h) {
  return ({
    ...
    ({
      ...
      ({
        void**  (* fd4_mapF) (void**,  uint64_t  ) = fd4_mapF_clo[0];
        fd4_mkclosure(fd4___final4, 4, fd4_h, fd4_mapF, fd4_mapF_clo, fd4_c);
      });
    });
  });
}
                      ...
                      ({
                        ...
                        ({
                          ...
                          fd4_printn((uint64_t)fd4_c + ({
                            void**  fd4___clo22 = ({
                              void**  fd4___clo21 = fd4_mapZ( fd4_mapZ_clo
                              , fd4_k );
                              ({
...
uint64_t* fd4main() {
  fd4_final = (void *)(({
    uint64_t  fd4_c = 200;
    ({
      void**  fd4_mapF_clo = fd4_mkclosure(fd4___final0, 1, fd4_c);
      ({
        void**  (* fd4_mapF) (void**,  uint64_t  ) = fd4_mapF_clo[0];
        ({
