...
uint64_t fd4___snoc0 (void**  fd4_clo, uint64_t  fd4_n) {
  return ({
    uint64_t  fd4_xs = fd4_clo[1];
    ({
...
void** fd4_snoc (void**  fd4_snoc_clo, uint64_t  fd4_xs) {
  return fd4_mkclosure(fd4___snoc0, 1, fd4_xs);
}
uint64_t fd4_l;
uint64_t fd4_h;
uint64_t* fd4main() {
  ...
  fd4_nil = (void *)(0);
  fd4_l = (void *)(({
    void**  fd4___clo5 = fd4_snoc( fd4_mkclosure(fd4_snoc, 0)
    , ({
      void**  fd4___clo3 = fd4_snoc( fd4_mkclosure(fd4_snoc, 0)
      , ({
        void**  fd4___clo1 = fd4_snoc(fd4_mkclosure(fd4_snoc, 0), 0);
        ({
          uint64_t  (* fd4___var1) (void**,  uint64_t  ) = fd4___clo1[0];
          fd4___var1(fd4___clo1, 8);
        });
      }) );
      ({
        uint64_t  (* fd4___var3) (void**,  uint64_t  ) = fd4___clo3[0];
        fd4___var3(fd4___clo3, 7);
      });
    }) );
    ({
      uint64_t  (* fd4___var5) (void**,  uint64_t  ) = fd4___clo5[0];
      fd4___var5(fd4___clo5, 6);
    });
  }));
  fd4_h = (void *)(fd4_head( fd4_mkclosure(fd4_head, 0)
  , fd4_tail(fd4_mkclosure(fd4_tail, 0), fd4_l) ));
  fd4_printn((uint64_t)fd4_h)
  ;
  return 0;
}