...
uint64_t fd4___snoc0 (void**  fd4_clo, uint64_t  fd4_xs) {
  return ({
...
void** fd4_snoc (void**  fd4_snoc_clo, uint64_t  fd4_n) {
  return fd4_mkclosure(fd4___snoc0, 1, fd4_n);
}
...
uint64_t* fd4main() {
  fd4_base = (void *)(10);
  fd4_l = (void *)(({
    void**  fd4___clo5 = fd4_snoc(fd4_mkclosure(fd4_snoc, 0), 3);
    ({
      uint64_t  (* fd4___var5) (void**,  uint64_t  ) = fd4___clo5[0];
      fd4___var5( fd4___clo5
      , ({
        void**  fd4___clo3 = fd4_snoc(fd4_mkclosure(fd4_snoc, 0), 2);
        ({
          uint64_t  (* fd4___var3) (void**,  uint64_t  ) = fd4___clo3[0];
          fd4___var3( fd4___clo3
          , ({
            void**  fd4___clo1 = fd4_snoc(fd4_mkclosure(fd4_snoc, 0), 1);
            ({
              uint64_t  (* fd4___var1) (void**,  uint64_t  ) = fd4___clo1[0];
  ...
  fd4_sm = (void *)(({
    ...
    , fd4_mult(fd4_mkclosure(fd4_mult, 0), 2) );
    ({
      uint64_t  (* fd4___var2) (void**,  uint64_t  ) = fd4___clo2[0];
      fd4___var2(fd4___clo2, fd4_l);
    });
  }));
  fd4_printn((uint64_t)fd4_sm)
  ;
  return 0;
}